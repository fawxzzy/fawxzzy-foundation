...
3. Run `pnpm verify:local` to validate required files and registry invariants.
...
Attach GitHub repository metadata, Vercel project metadata, and deployment status receipts.
